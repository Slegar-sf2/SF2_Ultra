...
cs_5149A:       textCursor 517
                ...
                nextText $0,ALLY_SARAH  ; "No?  Really?{N}Then I'm not going either!{W2}"
                nextSingleText $C0,ALLY_JAHA ; "{LEADER}, maybe we can{N}meet the Princess!{N}Are you going with us?{W1}"
                nextSingleText $0,ALLY_SARAH ; "But, if you change your{N}mind, let me know right{N}away!{W1}"
                entityActionsWait ALLY_SARAH
                 moveLeft 2
                 moveUp 1
...
cs_516A8:       textCursor 662
                nextSingleText $0,ALLY_SHADE ; "Here you are!{N}I've been waiting.{W1}"
                moveNextToPlayer ALLY_SHADE,LEFT
                nextSingleText $0,ALLY_SHADE; "A soldier said you went{N}into the castle.{N}Is that true?{W2}{N}Oooww!  I missed it!{N}I would've woken up early{N}if I knew that...!{W1}{N}So I came to meet you{N}here, {LEADER}.{N}You're going to Yeel, right?{W2}{N}Under the King's orders!{N}Cool!  Of course, I'm{N}going too!{W1}"
                join ALLY_SHADE
                nextSingleText $0,ALLY_SHADE ; "Let's go!{W1}"
                followEntity ALLY_SHADE,ALLY_JAHA,2
                csc_end