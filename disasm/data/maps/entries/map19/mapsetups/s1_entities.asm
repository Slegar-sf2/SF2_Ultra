...
ms_map19_Entities:
                ...
                msFixedEntity 28, 17, DOWN, MAPSPRITE_SOLDIER1, eas_Init
                msFixedEntity 30, 17, DOWN, MAPSPRITE_SOLDIER1, eas_Init
                msFixedEntity 29, 8, DOWN, MAPSPRITE_SOLDIER2, eas_LeftRightMoveLoop
