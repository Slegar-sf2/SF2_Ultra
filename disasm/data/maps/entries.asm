...
Map96:          include "data\maps\entries\Map96\00-tilesets.asm"    ; 
                dc.l Map96s0_Blocks
                dc.l Map96s1_Layout
                dc.l Map96s2_Areas
                dc.l Map96s3_FlagEvents
                dc.l Map96s4_StepEvents
                dc.l Map96s5_RoofEvents
                dc.l Map96s6_WarpEvents
                dc.l Map96s7_ChestItems
                dc.l Map96s8_OtherItems
                dc.l $FFFFFFFF
Map96s2_Areas:  include "data\maps\entries\Map96\2-areas.asm"    ; 
Map96s3_FlagEvents:include "data\maps\entries\Map96\3-flag-events.asm"    ; 
Map96s4_StepEvents:include "data\maps\entries\Map96\4-step-events.asm"    ; 
Map96s5_RoofEvents:include "data\maps\entries\Map96\5-roof-events.asm"    ; 
Map96s6_WarpEvents:include "data\maps\entries\Map96\6-warp-events.asm"    ; 
Map96s7_ChestItems:include "data\maps\entries\Map96\7-chest-items.asm"    ; 
Map96s8_OtherItems:include "data\maps\entries\Map96\8-other-items.asm"    ; 
Map96s0_Blocks: incbin "data/maps/entries/Map96/0-blocks.bin"
Map96s1_Layout: incbin "data/maps/entries/Map96/1-layout.bin"
;Map96s9_Animations:include "data\maps\entries\Map96\9-animations.asm"    ;
Map97:          include "data\maps\entries\Map97\00-tilesets.asm"    ; 
                dc.l Map97s0_Blocks
                dc.l Map97s1_Layout
                dc.l Map97s2_Areas
                dc.l Map97s3_FlagEvents
                dc.l Map97s4_StepEvents
                dc.l Map97s5_RoofEvents
                dc.l Map97s6_WarpEvents
                dc.l Map97s7_ChestItems
                dc.l Map97s8_OtherItems
                dc.l $FFFFFFFF
Map97s2_Areas:  include "data\maps\entries\Map97\2-areas.asm"    ; 
Map97s3_FlagEvents:include "data\maps\entries\Map97\3-flag-events.asm"    ; 
Map97s4_StepEvents:include "data\maps\entries\Map97\4-step-events.asm"    ; 
Map97s5_RoofEvents:include "data\maps\entries\Map97\5-roof-events.asm"    ; 
Map97s6_WarpEvents:include "data\maps\entries\Map97\6-warp-events.asm"    ; 
Map97s7_ChestItems:include "data\maps\entries\Map97\7-chest-items.asm"    ; 
Map97s8_OtherItems:include "data\maps\entries\Map97\8-other-items.asm"    ; 
Map97s0_Blocks: incbin "data/maps/entries/Map97/0-blocks.bin"
Map97s1_Layout: incbin "data/maps/entries/Map97/1-layout.bin"
Map98:          include "data\maps\entries\Map98\00-tilesets.asm"    ; 
                dc.l Map98s0_Blocks
                dc.l Map98s1_Layout
                dc.l Map98s2_Areas
                dc.l Map98s3_FlagEvents
                dc.l Map98s4_StepEvents
                dc.l Map98s5_RoofEvents
                dc.l Map98s6_WarpEvents
                dc.l Map98s7_ChestItems
                dc.l Map98s8_OtherItems
                dc.l $FFFFFFFF
Map98s2_Areas:  include "data\maps\entries\Map98\2-areas.asm"    ; 
Map98s3_FlagEvents:include "data\maps\entries\Map98\3-flag-events.asm"    ; 
Map98s4_StepEvents:include "data\maps\entries\Map98\4-step-events.asm"    ; 
Map98s5_RoofEvents:include "data\maps\entries\Map98\5-roof-events.asm"    ; 
Map98s6_WarpEvents:include "data\maps\entries\Map98\6-warp-events.asm"    ; 
Map98s7_ChestItems:include "data\maps\entries\Map98\7-chest-items.asm"    ; 
Map98s8_OtherItems:include "data\maps\entries\Map98\8-other-items.asm"    ; 
Map98s0_Blocks: incbin "data/maps/entries/Map98/0-blocks.bin"
Map98s1_Layout: incbin "data/maps/entries/Map98/1-layout.bin"
Map99:          include "data\maps\entries\Map99\00-tilesets.asm"    ; 
                dc.l Map99s0_Blocks
                dc.l Map99s1_Layout
                dc.l Map99s2_Areas
                dc.l Map99s3_FlagEvents
                dc.l Map99s4_StepEvents
                dc.l Map99s5_RoofEvents
                dc.l Map99s6_WarpEvents
                dc.l Map99s7_ChestItems
                dc.l Map99s8_OtherItems
                dc.l $FFFFFFFF
Map99s2_Areas:  include "data\maps\entries\Map99\2-areas.asm"    ; 
Map99s3_FlagEvents:include "data\maps\entries\Map99\3-flag-events.asm"    ; 
Map99s4_StepEvents:include "data\maps\entries\Map99\4-step-events.asm"    ; 
Map99s5_RoofEvents:include "data\maps\entries\Map99\5-roof-events.asm"    ; 
Map99s6_WarpEvents:include "data\maps\entries\Map99\6-warp-events.asm"    ; 
Map99s7_ChestItems:include "data\maps\entries\Map99\7-chest-items.asm"    ; 
Map99s8_OtherItems:include "data\maps\entries\Map99\8-other-items.asm"    ; 
Map99s0_Blocks: incbin "data/maps/entries/Map99/0-blocks.bin"
Map99s1_Layout: incbin "data/maps/entries/Map99/1-layout.bin"
Map100:          include "data\maps\entries\Map100\00-tilesets.asm"    ; 
                dc.l Map100s0_Blocks
                dc.l Map100s1_Layout
                dc.l Map100s2_Areas
                dc.l Map100s3_FlagEvents
                dc.l Map100s4_StepEvents
                dc.l Map100s5_RoofEvents
                dc.l Map100s6_WarpEvents
                dc.l Map100s7_ChestItems
                dc.l Map100s8_OtherItems
                dc.l Map100s9_Animations
Map100s2_Areas:  include "data\maps\entries\Map100\2-areas.asm"    ; 
Map100s3_FlagEvents:include "data\maps\entries\Map100\3-flag-events.asm"    ; 
Map100s4_StepEvents:include "data\maps\entries\Map100\4-step-events.asm"    ; 
Map100s5_RoofEvents:include "data\maps\entries\Map100\5-roof-events.asm"    ; 
Map100s6_WarpEvents:include "data\maps\entries\Map100\6-warp-events.asm"    ; 
Map100s7_ChestItems:include "data\maps\entries\Map100\7-chest-items.asm"    ; 
Map100s8_OtherItems:include "data\maps\entries\Map100\8-other-items.asm"    ; 
