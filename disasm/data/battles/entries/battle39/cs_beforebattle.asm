...
ce_4E4AC:       mainEntity 8,9,DOWN
                ...
                entity 6,21,UP,MAPSPRITE_CHAOS_WARRIOR,eas_Init
                entity 7,22,UP,MAPSPRITE_MINOTAUR,eas_Init
                entity 9,22,UP,MAPSPRITE_PYROHYDRA,eas_Init
                entity 10,21,UP,MAPSPRITE_CYCLOPS,eas_Init
                dc.w $FFFF
