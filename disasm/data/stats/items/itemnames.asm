...
tbl_ItemNames:  itemName "Medical", 13, "Herb"
            ...
            if (STANDARD_BUILD&EXPANDED_ITEMS_AND_SPELLS=1)
                ...
                itemName "Pokemon"
                itemName "Blizzard"
                itemName "Healing", 13, "Berries"
                itemName "Vicar", 13, "Ring"
                itemName "Attack", 13, "Ring"
                itemName "Hummer"
                itemName "Snow", 13, "flake"
                itemName "Arson"
                itemName "Claws"
                itemName "Hyper", 13, "Jaha"
                itemName "Bronze", 13, "Sword"
                itemName "Magic", 13, "Power"
                itemName "Bikini"
                itemName "Egg"
                itemName "Druid", 13, "Staff"
                itemName "item152"
                itemName "item153"
                itemName "item154"
                itemName "item155"
